...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CUSTOMER', 'EMPLOYEE', 'ADMIN', 'MASTER_ADMIN', 'DEVELOPER', 'TESTER');
...
-- CreateEnum
CREATE TYPE "OrderEventType" AS ENUM ('ORDER_PLACED', 'STATUS_CHANGED', 'PAYMENT_CONFIRMED', 'PAYMENT_FAILED', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED', 'NOTE_ADDED');

-- CreateEnum
CREATE TYPE "MessageRole" AS ENUM ('USER', 'ASSISTANT');

-- CreateEnum
CREATE TYPE "AdminRequestType" AS ENUM ('ROLE_CHANGE', 'DELETE_USER', 'EDIT_USER', 'CREATE_PRODUCT', 'EDIT_PRODUCT', 'DELETE_PRODUCT', 'UPDATE_ORDER_STATUS', 'EDIT_ORDER');
...
-- CreateIndex
CREATE INDEX "OrderEvent_userId_createdAt_idx" ON "OrderEvent"("userId", "createdAt" DESC);
